...
if hasattr(old_module, "__loader__"):
    new_module.__loader__ = old_module.__loader__
if hasattr(old_module, "__importsub__"):
    new_module.__importsub__ = old_module.__importsub__
